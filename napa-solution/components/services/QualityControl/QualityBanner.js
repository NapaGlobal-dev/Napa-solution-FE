...
export default function Banner({ data }) {
  const banner = getData(data, /QualityServices_Banner_Img/)[0];
  const title = getData(data, /QualityServices_Banner_Title/)[0];
  const subtitle = getData(data, /QualityServices_Banner_SubTitle/)[0];
  const content = getData(data, /QualityServices_Banner_Content/)[0];
  const subcontent = getData(data, /QualityServices_Banner_SubContent/)[0];
  useEffect(() => {
