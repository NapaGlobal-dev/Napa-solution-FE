...
export default function Banner({ data }) {
  const banner = getData(data, /AIServices_Banner_Img/)[0];
  const title = getData(data, /AIServices_Banner_Title/)[0];
  const subtitle = getData(data, /AIServices_Banner_SubTitle/)[0];
  const content = getData(data, /AIServices_Banner_Content/)[0];
  const subcontent = getData(data, /AIServices_Banner_SubContent/)[0];
  useEffect(() => {
