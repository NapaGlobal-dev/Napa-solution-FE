			...
			<div className="container-contact">
                ...
                c0.006-0.006,0.011-0.013,0.018-0.019C513.968,262.339,513.943,249.635,506.134,241.843z"
                  ...
                  c0.006-0.006,0.011-0.013,0.018-0.019C513.968,262.339,513.943,249.635,506.134,241.843z"
					...
					<p id="down-up">
						<span className="address-highlight">本社: </span>
						{data?.Footer_Address_JP_Head?.value}
					</p>
					<p id="down-up">
						<span className="address-highlight">秋葉原営業所: </span>
						{data?.Footer_Address_JP_Branch?.value}
					</p>
					<p id="down-up">
